/*
  # Sample Data for TechForge Ecommerce Platform

  1. Categories
    - Smartphones, Laptops, Desktops, Monitors, Accessories
  2. Component Types
    - RAM, Processor, Storage, Camera, Display, OS, Graphics Card, Battery, Color, Warranty
  3. Components
    - Various options for each component type with specifications
  4. Products
    - Sample customizable products
  5. Product Components
    - Relationships between products and their available components
*/
